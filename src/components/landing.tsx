...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-[#ede2bf] justify-center items-center">
      ...
      <section className="container px-4 py-16 md:py-24 flex flex-col justify-center">
        ...
        <div className="space-y-8">
          ...
          <FeatureCard
            ...
            description="Visualize your productivity levels with intuitive colors"
            icon="Palette"
            details="Our color-coded tracking system provides instant visual feedback on your productivity levels. From light to dark shades, each color represents your activity intensity, making it easy to assess your performance at a glance. This visual motivation helps reinforce positive habits and encourages you to maintain your productivity streaks."
          />
          <FeatureCard
